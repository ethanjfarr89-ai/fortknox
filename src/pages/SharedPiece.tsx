    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
        <div className="text-center space-y-3">
          <img src="/logo.png" alt="Trove" className="h-20 mx-auto rounded-lg" />
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <header className="border-b border-neutral-800 bg-neutral-900/80 backdrop-blur-sm sticky top-0 z-30">
        <div className="max-w-2xl mx-auto px-4 py-2 flex items-center justify-between">
          <a href="/"><img src="/logo-horizontal.png" alt="Trove" className="h-9" /></a>
          {owner.display_name && (
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* CTA */}
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 text-center space-y-4 mt-8">
          <img src="/logo.png" alt="Trove" className="h-24 mx-auto rounded-lg" />
